                    ...
                    <div class="am-u-sm-12 am-u-md-6">
                        <div class="am-btn-toolbar">>
                            <div class="am-btn-group am-btn-group-xs">
                                <a href="../work.jsp" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <td>1</td>
                                    <td class="am-hide-sm-only">数据库原理练习题</td>
                                    <td class="am-hide-sm-only">个人作业</td>

                                    <td><button class="am-btn am-btn-default am-btn-xs am-hide-sm-only"><span></span> 上传</button></td>
                                    <td class="am-hide-sm-only">2020年3月4日 7:28:47</td>
                                    <td class="am-hide-sm-only">2020年4月4日 7:28:47</td>
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
