...
<head>
    ...
    <title>组卷页面</title>
    <meta name="description" content="组卷">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-hide-sm-only am-u-md-1 am-text-left" style="color: red">*</div>
                                    <div class="am-u-sm-3 am-form-group-sm am-align-left">总分100分</div>
                                </div>
